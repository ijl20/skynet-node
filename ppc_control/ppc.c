...
#define SKYNET_SRV_PORT 83
#define SKYNET_SRV_NAME "carrier.csi.cam.ac.uk"
#define SKYNET_SRV_IP "131.111.56.4"
...
int child_send_msg(char *msg)
{
  ...
  if (n_written < msg_size) 
  {
      /* debug */
      return 1;
      err_exit("ppc: send_child_msg: n_written");
  }
  return 0;
}
